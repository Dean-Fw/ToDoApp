...
class ProjectListItem(OneLineListItem):
    ...
    def move_list(self):
        JsonData("data.json").move_note(MDApp.get_running_app().root.ids.screen_manager.current_screen.name, self.card_called_from.ids.note_title.text, self.project_screen.name)
